...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap-test-organization-jk/rhtap-qe-java-springboot:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/fksh0kvbz-java-springboot-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-8htmw.8htmw.sandbox1970.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-8htmw.8htmw.sandbox1970.opentlc.com}
